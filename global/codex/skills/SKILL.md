...
3. **Group skills by workflow stage** using this static mapping:
   ...
   | Planning | `brainstorm`, `brainstorm-kanban`, `concept-exploration`, `feature-interview`, `spec-interview`, `spec-interview --ideas`, `ui-interview`, `ux-variation`, `ui-consolidate`, `spec-interview-kanban`, `experiment`, `clone-spec-store` (project-fleet pack) |
