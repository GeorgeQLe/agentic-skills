...
description: Audit and fill missing lane metadata (Mode, Depends on, Owns) in agent-team and implementation-safe execution profiles in tasks/todo.md
type: execution
version: 1.0.0
---
...
- Do not invent new lanes. Only fill missing metadata on lanes that already exist.
