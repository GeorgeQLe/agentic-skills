...
const expectedMatrix = new Map([
  ...
  ['alignment pages open <alignment/page.html|briefing-slides/page.html> [--browser <browser>]', { owner: 'Node-owned wrapper', bash: 'No', jq: 'No' }],
  ...
  ['briefing slides audit', { owner: 'Node-owned wrapper', bash: 'No', jq: 'No' }],
