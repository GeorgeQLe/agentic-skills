...
const repoOwnedEntries = [
  ...
  { fromRoot: repoRoot, from: "scripts/upgrade-prototype-session-loop.mjs", to: "scripts/upgrade-prototype-session-loop.mjs" },
  ...
  { fromRoot: repoRoot, from: "docs/prototype-session-loop-convention.md", to: "assets/prototype-session-loop-convention.md" },
