# First-Party Skills Showcase Newsletter Capture

## Overview

Extend the existing Skills Showcase website from a mostly static proof surface into a minimal first-party capture app for newsletter interest.
...
- Capture newsletter-interest emails through a first-party form on the Skills Showcase follow page.
...
- Replacing the Skills Showcase visual design or information architecture.
...
- What production domain or subdomain should host the app-enabled showcase?
...
- Corrected: `[from codebase]` The Skills Showcase website already exists under `docs/skills-showcase/`. Risk if wrong: implementation could waste time rebuilding proven static surfaces instead of porting them.
