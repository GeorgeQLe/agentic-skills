...
**Recommended next command:** /ord-scan (next experiment) or /pack install devtool inside Claude Code, or npx skillpacks install devtool from the project shell, then /devtool-adoption (graduate)
```
