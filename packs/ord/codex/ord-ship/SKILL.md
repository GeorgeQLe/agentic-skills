...
**Recommended next command:** $ord-scan (next experiment) or $pack install devtool inside Codex, or npx skillpacks install devtool from the project shell, then $devtool-adoption (graduate)
```
