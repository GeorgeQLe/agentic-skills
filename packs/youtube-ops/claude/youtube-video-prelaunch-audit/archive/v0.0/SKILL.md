...
Audit one uploaded but not-yet-public YouTube video before launch. Decide whether it is ready to publish, needs metadata-only polish, needs a targeted edit, or should be held for significant rework. This is the prelaunch lane; use `/youtube-video-audit` after publication for performance diagnosis against real audience metrics.
