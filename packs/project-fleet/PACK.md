...
`clone-spec-store` defines lawful functional-parity spec stores and portfolio gates. `project-fleet` orchestrates downstream work queues and guarded batches. `spin-off` extracts bounded source areas into new repositories with private/public readiness gates.
