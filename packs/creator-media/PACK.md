...
Install this pack when a project needs platform capability mapping, evidence normalization, channel audits, packaging audits, description optimization, portfolio strategy, peer benchmarking, search positioning, cadence diagnosis, creator positioning, programming plans, series specs, product-to-media mapping, video scripting, video builds, or recurring metrics reviews.
