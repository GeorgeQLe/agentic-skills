# experience-map changelog (claude)

## v0.11 - 2026-07-06

- Added `briefing-slides` to the required conventions via the shared packaged convention resolver. Dense alignment/interrogation pages remain source artifacts, while `briefing-slides/experience-map-{topic}.html` is now the primary review surface and compiled YAML routes back to `/experience-map`.
...
- Initial version — Adaptive Path experience map with doing/thinking/feeling layers, emotional arc, pain/delight moments, and channel transitions
