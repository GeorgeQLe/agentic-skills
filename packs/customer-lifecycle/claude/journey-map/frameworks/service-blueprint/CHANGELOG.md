# service-blueprint changelog (claude)

## v0.11 - 2026-07-06

- Added `briefing-slides` to the required conventions via the shared packaged convention resolver. Dense alignment/interrogation pages remain source artifacts, while `briefing-slides/service-blueprint-{topic}.html` is now the primary review surface and compiled YAML routes back to `/service-blueprint`.
