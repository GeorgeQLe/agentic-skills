...
- Reframed branch lifecycle as a compatibility/recovery wrapper that delegates normal branch and pull-request operations to the canonical GitHub safety skills.
