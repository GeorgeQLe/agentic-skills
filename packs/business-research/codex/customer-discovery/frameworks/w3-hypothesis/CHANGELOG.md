# w3-hypothesis changelog (codex)

## v0.11 - 2026-07-06

- Added `briefing-slides` to the required conventions via the shared packaged convention resolver. Dense alignment/interrogation pages remain source artifacts, while `briefing-slides/w3-hypothesis-{topic}.html` is now the primary review surface and compiled YAML routes back to `$w3-hypothesis`.
...
- Initial version: Schwartzfarb W3 (WHO/WHAT/WHY) hypothesis generation, disproval testing, and per-candidate confidence scoring
