...
const approvedHeadingDrift = new Map([
  ...
  ["business-discovery/competitive-analysis", "Pre-existing heading shape drift outside this remediation."],
  ["business-discovery/customer-feedback", "Pre-existing heading shape drift outside this remediation."],
  ["business-discovery/enterprise-icp", "Pre-existing heading shape drift outside this remediation."],
  ["business-discovery/icp", "Pre-existing heading shape drift outside this remediation."],
  ["business-discovery/lean-canvas", "Pre-existing heading shape drift outside this remediation."],
  ["business-discovery/positioning", "Pre-existing heading shape drift outside this remediation."],
  ["business-discovery/value-prop-canvas", "Pre-existing heading shape drift outside this remediation."],
