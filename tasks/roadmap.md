...
Create the local three-repo layout for the already-documented `agentic-skills` split, with independent git repositories for skills source, Showcase app, and benchmark harness/results, and configure each checkout to point at its corresponding remote.
