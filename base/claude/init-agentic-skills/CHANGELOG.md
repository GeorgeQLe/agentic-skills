...
- Added npm-aware project-shell pack install guidance alongside Claude `/pack install` guidance for project-local domain workflows.
...
- Initial Claude global skill installer workflow.
