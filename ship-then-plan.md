...
2) **Ship the work:**
   ...
   b) Update `tasks/todo.md` — mark completed items as done.
   c) If there's a phased plan in `docs/`, check off completed steps/milestones there too.
...
- Plans and active work go in `tasks/todo.md`. Phased plans go in `docs/`.
