...
- [x] **Step 2: `spec-interview-kanban`** (originally `plan-interview-kanban`, renamed post-Phase-11) — full copy of spec-interview + update matching Backlog card with spec (search all lists, fuzzy match, ask if ambiguous)
