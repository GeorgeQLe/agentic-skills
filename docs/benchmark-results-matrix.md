...
| `session-triage` | Claude | `tests/benchmarks/runs/session-triage-claude-e5f0772b/report.json` | 3 | 100% | 93.8% | `benchmark/review-session-triage-2026-05-13.md` | graded | Curated report: `benchmark/test-session-triage-2026-05-13.md`. Subjective review median score available. |
| `session-triage` | Codex | `tests/benchmarks/runs/session-triage-codex-374ad6f0/report.json` | 3 | 100% | 95.8% | `benchmark/review-session-triage-2026-05-13.md` | graded | Curated report: `benchmark/test-session-triage-2026-05-13.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-fbb3ca80/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
