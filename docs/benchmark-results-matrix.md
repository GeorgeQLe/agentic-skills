...
| `ship-end` | Claude | `tests/benchmarks/runs/ship-end-claude-0190fdda/report.json` | 3 | 100% | 100.0% | none | graded | Curated report: `benchmark/test-ship-end-2026-05-18.md`. |
| `ship-end` | Codex | `tests/benchmarks/runs/ship-end-codex-4fbde9d6/report.json` | 3 | 100% | 100.0% | none | graded | Curated report: `benchmark/test-ship-end-2026-05-18.md`. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-fee787f2/report.json` | 3 | 100% | 93.9% | `benchmark/review-update-packages-2026-05-18.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-ca40a8d5/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
