...
> Generated by `apps/skills-showcase/scripts/generate-skills-showcase-data.mjs` on 2026-06-14. Do not edit by hand.
...
|---|---|---:|---:|---:|---:|---|---|---|
| `migrate` | Claude | `tests/benchmarks/runs/migrate-claude-7c742313/report.json` | 3 | 33% | 85.6% | none | graded | Curated report: `benchmark/test-migrate-2026-05-31.md`. |
| `migrate` | Codex | `tests/benchmarks/runs/migrate-codex-f3658761/report.json` | 3 | 33% | 79.5% | none | graded | Curated report: `benchmark/test-migrate-2026-05-31.md`. |
...
|---|---|---|---|---|
| `exec` | Codex | `tests/benchmarks/runs/exec-codex-586ed3cd/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. |
