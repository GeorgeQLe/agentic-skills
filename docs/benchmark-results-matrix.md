...
| `feature-interview` | Claude | `tests/benchmarks/runs/feature-interview-claude-e499a20d/report.json` | 1 | 100% | 77.8% | `benchmark/review-feature-interview-2026-05-17.md` | graded | Curated report: `benchmark/test-feature-interview-2026-05-18.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
| `feature-interview` | Codex | `tests/benchmarks/runs/feature-interview-codex-e6208aac/report.json` | 3 | 100% | 100.0% | `benchmark/review-feature-interview-2026-05-17.md` | graded | Curated report: `benchmark/test-feature-interview-2026-05-18.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-59725a88/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
