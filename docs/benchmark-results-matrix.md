...
|---|---|---:|---:|---:|---:|---|---|---|
| `analyze-sessions` | Claude | `tests/benchmarks/runs/analyze-sessions-claude-fa3b696a/report.json` | 3 | 100% | 92.3% | `benchmark/review-analyze-sessions-2026-05-15.md` | graded | Curated report: `benchmark/test-analyze-sessions-2026-05-15.md`. Subjective review median score available. |
| `analyze-sessions` | Codex | `tests/benchmarks/runs/analyze-sessions-codex-e68803b1/report.json` | 3 | 100% | 92.3% | `benchmark/review-analyze-sessions-2026-05-15.md` | graded | Curated report: `benchmark/test-analyze-sessions-2026-05-15.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-6a8743dc/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
