...
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-0ceac781/report.json` | 3 | 100% | 99.2% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-17.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-9229ccd3/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
