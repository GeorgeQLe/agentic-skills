...
| `benchmark-agent-review` | Claude | `tests/benchmarks/runs/benchmark-agent-review-claude-29400696/report.json` | 3 | 100% | 86.7% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-18.md`. Subjective review median score available. |
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-d0b564cf/report.json` | 3 | 100% | 82.2% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-18.md`. Subjective review median score available. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-12d8fabf/report.json` | 3 | 33% | 82.8% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. Subjective review median score available. |
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-d7c07a6a/report.json` | 3 | 100% | 98.0% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-0704f518/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
