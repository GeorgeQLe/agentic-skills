...
> Generated by `scripts/generate-skills-showcase-data.mjs` on 2026-05-14. Do not edit by hand.
...
| `content-programming` | Claude | `tests/benchmarks/runs/content-programming-claude-9f0c62c8/report.json` | 3 | 100% | 96.7% | none | graded | Curated report: `benchmark/test-content-programming-2026-05-14.md`. |
| `content-programming` | Codex | `tests/benchmarks/runs/content-programming-codex-ff03c35c/report.json` | 3 | 100% | 97.5% | none | graded | Curated report: `benchmark/test-content-programming-2026-05-14.md`. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-93c55378/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
