...
| `bootstrap-repo` | Claude | `tests/benchmarks/runs/bootstrap-repo-claude-2e479a9c/report.json` | 3 | 0% | 59.1% | none | graded | Curated report: `benchmark/test-bootstrap-repo-2026-05-19.md`. |
| `bootstrap-repo` | Codex | `tests/benchmarks/runs/bootstrap-repo-codex-48625841/report.json` | 3 | 0% | 52.3% | none | graded | Curated report: `benchmark/test-bootstrap-repo-2026-05-19.md`. |
| `brainstorm` | Claude | `tests/benchmarks/runs/brainstorm-claude-84ef3204/report.json` | 3 | 100% | 89.4% | none | graded | Curated report: `benchmark/test-brainstorm-2026-05-19.md`. |
| `brainstorm` | Codex | `tests/benchmarks/runs/brainstorm-codex-3220463d/report.json` | 3 | 100% | 88.6% | none | graded | Curated report: `benchmark/test-brainstorm-2026-05-19.md`. |
...
| `branch-lifecycle` | Claude | `tests/benchmarks/runs/branch-lifecycle-claude-f4d62fe4/report.json` | 3 | 100% | 84.1% | none | graded | Curated report: `benchmark/test-branch-lifecycle-2026-05-19.md`. |
| `branch-lifecycle` | Codex | `tests/benchmarks/runs/branch-lifecycle-codex-436451d3/report.json` | 3 | 100% | 84.8% | none | graded | Curated report: `benchmark/test-branch-lifecycle-2026-05-19.md`. |
...
| `codebase-status` | Claude | `tests/benchmarks/runs/codebase-status-claude-c76423ae/report.json` | 3 | 0% | 60.6% | none | graded | Curated report: `benchmark/test-codebase-status-2026-05-19.md`. |
| `codebase-status` | Codex | `tests/benchmarks/runs/codebase-status-codex-6f32a832/report.json` | 3 | 100% | 90.2% | none | graded | Curated report: `benchmark/test-codebase-status-2026-05-19.md`. |
...
| `concept-exploration` | Claude | `tests/benchmarks/runs/concept-exploration-claude-0516a566/report.json` | 3 | 67% | 76.5% | none | graded | Curated report: `benchmark/test-concept-exploration-2026-05-19.md`. |
| `concept-exploration` | Codex | `tests/benchmarks/runs/concept-exploration-codex-bcc77bc6/report.json` | 3 | 100% | 85.6% | none | graded | Curated report: `benchmark/test-concept-exploration-2026-05-19.md`. |
| `consolidate-variations` | Claude | `tests/benchmarks/runs/consolidate-variations-claude-8f0578f8/report.json` | 3 | 33% | 74.2% | none | graded | Curated report: `benchmark/test-consolidate-variations-2026-05-19.md`. |
| `consolidate-variations` | Codex | `tests/benchmarks/runs/consolidate-variations-codex-d0205b3a/report.json` | 3 | 0% | 69.7% | none | graded | Curated report: `benchmark/test-consolidate-variations-2026-05-19.md`. |
...
| `create-agentic-skill` | Claude | `tests/benchmarks/runs/create-agentic-skill-claude-902cfd26/report.json` | 3 | 100% | 87.1% | none | graded | Curated report: `benchmark/test-create-agentic-skill-2026-05-19.md`. |
| `create-agentic-skill` | Codex | `tests/benchmarks/runs/create-agentic-skill-codex-086796dd/report.json` | 3 | 100% | 88.6% | none | graded | Curated report: `benchmark/test-create-agentic-skill-2026-05-19.md`. |
| `create-local-skill` | Claude | `tests/benchmarks/runs/create-local-skill-claude-590fbc1c/report.json` | 3 | 100% | 86.4% | none | graded | Curated report: `benchmark/test-create-local-skill-2026-05-19.md`. |
| `create-local-skill` | Codex | `tests/benchmarks/runs/create-local-skill-codex-f5640d57/report.json` | 3 | 100% | 88.6% | none | graded | Curated report: `benchmark/test-create-local-skill-2026-05-19.md`. |
