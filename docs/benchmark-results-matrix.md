...
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-337a5d5e/report.json` | 3 | 100% | 100.0% | `benchmark/review-update-packages-2026-05-18.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. Subjective review median score available. |
