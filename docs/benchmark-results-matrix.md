...
| `benchmark-agent-review` | Claude | `tests/benchmarks/runs/benchmark-agent-review-claude-3378af86/report.json` | 3 | 100% | 99.2% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-17.md`. Subjective review median score available. |
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-1c0359b3/report.json` | 1 | 100% | 100.0% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-e7c523af/report.json` | 3 | 33% | 83.3% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. Subjective review median score available. |
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-3a7b1c07/report.json` | 1 | 100% | 97.1% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-cbe118a8/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
