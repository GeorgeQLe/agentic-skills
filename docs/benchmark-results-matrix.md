...
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-558b7ba6/report.json` | 3 | 100% | 98.3% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-17.md`. Subjective review median score available. |
...
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-2216d07d/report.json` | 3 | 100% | 94.2% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-cb7ad099/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
