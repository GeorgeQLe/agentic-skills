...
|---|---|---:|---:|---:|---:|---|---|---|
| `analyze-sessions` | Claude | `tests/benchmarks/runs/analyze-sessions-claude-0cb06af8/report.json` | 3 | 100% | 92.3% | `benchmark/review-analyze-sessions-2026-05-15.md` | graded | Curated report: `benchmark/test-analyze-sessions-2026-05-15.md`. Subjective review median score available. |
| `analyze-sessions` | Codex | `tests/benchmarks/runs/analyze-sessions-codex-2da5dfa4/report.json` | 3 | 100% | 92.3% | `benchmark/review-analyze-sessions-2026-05-15.md` | graded | Curated report: `benchmark/test-analyze-sessions-2026-05-15.md`. Subjective review median score available. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-4f02cadc/report.json` | 3 | 0% | 39.4% | none | graded | — |
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-febcb2db/report.json` | 3 | 0% | 38.6% | none | graded | — |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-9f81c5b0/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
