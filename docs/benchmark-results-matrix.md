...
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-120085b6/report.json` | 1 | 100% | 100.0% | `benchmark/review-update-packages-2026-05-18.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-f8943d99/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
