...
| `benchmark-agent-review` | Claude | `tests/benchmarks/runs/benchmark-agent-review-claude-2be30316/report.json` | 1 | 100% | 98.3% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-18.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-089d4f4f/report.json` | 3 | 100% | 98.9% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-18.md`. Subjective review median score available. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-fa542bcd/report.json` | 3 | 100% | 91.2% | `benchmark/review-update-packages-2026-05-18.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. Subjective review median score available. |
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-afdc4a08/report.json` | 1 | 100% | 98.8% | `benchmark/review-update-packages-2026-05-18.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-b413092c/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
