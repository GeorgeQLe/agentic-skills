...
| `feature-interview` | Claude | `tests/benchmarks/runs/feature-interview-claude-52b6ef8a/report.json` | 1 | 0% | 85.7% | none | graded | Curated report: `benchmark/test-feature-interview-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. |
| `feature-interview` | Codex | `tests/benchmarks/runs/feature-interview-codex-5bd5a8da/report.json` | 3 | 33% | 90.5% | none | graded | Curated report: `benchmark/test-feature-interview-2026-05-17.md`. |
...
| `roadmap` | Codex | `tests/benchmarks/runs/roadmap-codex-00c1a8a4/report.json` | 3 | 100% | 92.9% | none | graded | Curated report: `benchmark/test-roadmap-2026-05-17.md`. |
...
| `roadmap` | Claude | `tests/benchmarks/runs/roadmap-claude-ceadee35/report.json` | blocked/incomplete | Prefer the later evaluated report listed above. |
| `run` | Codex | `tests/benchmarks/runs/run-codex-79b2d69b/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
