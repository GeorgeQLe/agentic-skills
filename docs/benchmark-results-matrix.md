...
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-c8dbd66e/report.json` | 3 | 67% | 93.6% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. Subjective review median score available. |
