...
| `benchmark-agent-review` | Claude | `tests/benchmarks/runs/benchmark-agent-review-claude-f72e03c7/report.json` | 3 | 100% | 81.7% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-18.md`. Subjective review median score available. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-fa542bcd/report.json` | 3 | 100% | 91.2% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. Subjective review median score available. |
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-d7c07a6a/report.json` | 3 | 100% | 98.0% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-302d6113/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
