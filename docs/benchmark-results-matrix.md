...
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-03d220e0/report.json` | 3 | 100% | 98.5% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-18.md`. Subjective review median score available. |
