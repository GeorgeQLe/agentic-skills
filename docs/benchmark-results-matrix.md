...
| `feature-interview` | Claude | `tests/benchmarks/runs/feature-interview-claude-e5b18930/report.json` | 1 | 100% | 92.9% | none | graded | Curated report: `benchmark/test-feature-interview-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. |
| `feature-interview` | Codex | `tests/benchmarks/runs/feature-interview-codex-1ff31029/report.json` | 3 | 100% | 97.6% | none | graded | Curated report: `benchmark/test-feature-interview-2026-05-17.md`. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-edbfee8e/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
