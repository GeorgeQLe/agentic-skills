...
> Generated by `scripts/generate-skills-showcase-data.mjs` on 2026-05-19. Do not edit by hand.
...
| `design-system` | Claude | `tests/benchmarks/runs/design-system-claude-6f43736a/report.json` | 5 | 100% | 90.9% | none | graded | Curated report: `benchmark/test-design-system-2026-05-10.md`. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-7f46020c/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
