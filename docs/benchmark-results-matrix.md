...
| `feature-interview` | Claude | `tests/benchmarks/runs/feature-interview-claude-6bd2c89a/report.json` | 3 | 0% | 90.5% | none | graded | — |
| `feature-interview` | Codex | `tests/benchmarks/runs/feature-interview-codex-5bd5a8da/report.json` | 3 | 33% | 90.5% | none | graded | — |
...
| `roadmap` | Codex | `tests/benchmarks/runs/roadmap-codex-0c6a74ce/report.json` | 1 | 100% | 100.0% | none | graded | Curated report: `benchmark/test-roadmap-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. |
...
| `roadmap` | Claude | `tests/benchmarks/runs/roadmap-claude-ceadee35/report.json` | blocked/incomplete | Report exists with zero evaluated runs. |
