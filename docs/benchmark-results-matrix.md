...
| `bootstrap-repo` | Claude | `tests/benchmarks/runs/bootstrap-repo-claude-46e8d59b/report.json` | 3 | 0% | 59.1% | none | graded | Curated report: `benchmark/test-bootstrap-repo-2026-05-19.md`. |
| `bootstrap-repo` | Codex | `tests/benchmarks/runs/bootstrap-repo-codex-cbac0773/report.json` | 3 | 0% | 52.3% | none | graded | Curated report: `benchmark/test-bootstrap-repo-2026-05-19.md`. |
| `brainstorm` | Claude | `tests/benchmarks/runs/brainstorm-claude-62a7262f/report.json` | 3 | 100% | 89.4% | none | graded | Curated report: `benchmark/test-brainstorm-2026-05-19.md`. |
