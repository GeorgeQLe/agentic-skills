...
|---|---|---|---|---|
| `exec` | Codex | `tests/benchmarks/runs/exec-codex-21b353f3/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. |
