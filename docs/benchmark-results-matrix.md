...
| `session-triage` | Claude | `tests/benchmarks/runs/session-triage-claude-865e8407/report.json` | 3 | 100% | 100.0% | `benchmark/review-session-triage-2026-05-13.md` | graded | Curated report: `benchmark/test-session-triage-2026-05-13.md`. Subjective review median score available. |
| `session-triage` | Codex | `tests/benchmarks/runs/session-triage-codex-d417810e/report.json` | 3 | 67% | 82.5% | `benchmark/review-session-triage-2026-05-13.md` | graded | Curated report: `benchmark/test-session-triage-2026-05-13.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-ebbe375f/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
