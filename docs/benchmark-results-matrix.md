...
|---|---|---:|---:|---:|---:|---|---|---|
| `analyze-sessions` | Claude | `tests/benchmarks/runs/analyze-sessions-claude-2fbe5bb3/report.json` | 3 | 100% | 82.1% | `benchmark/review-analyze-sessions-2026-05-15.md` | graded | Curated report: `benchmark/test-analyze-sessions-2026-05-15.md`. Subjective review median score available. |
| `analyze-sessions` | Codex | `tests/benchmarks/runs/analyze-sessions-codex-fbd564cc/report.json` | 3 | 100% | 92.3% | `benchmark/review-analyze-sessions-2026-05-15.md` | graded | Curated report: `benchmark/test-analyze-sessions-2026-05-15.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-afa82170/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
