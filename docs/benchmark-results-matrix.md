...
| `ship` | Claude | `tests/benchmarks/runs/ship-claude-a11036e8/report.json` | 3 | 100% | 78.6% | `benchmark/review-ship-2026-05-11.md` | graded | Curated report: `benchmark/test-ship-2026-05-11.md`. Subjective review median score available. |
| `ship` | Codex | `tests/benchmarks/runs/ship-codex-7e3f4bab/report.json` | 3 | 100% | 78.6% | `benchmark/review-ship-2026-05-11.md` | graded | Curated report: `benchmark/test-ship-2026-05-11.md`. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-e8f2dbe7/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
