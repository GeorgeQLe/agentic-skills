...
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-9c6219ef/report.json` | 3 | 100% | 81.1% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-18.md`. Subjective review median score available. |
