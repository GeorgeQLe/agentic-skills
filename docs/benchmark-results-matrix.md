...
> Generated by `scripts/generate-skills-showcase-data.mjs` on 2026-05-17. Do not edit by hand.
...
| `benchmark-agent-review` | Claude | `tests/benchmarks/runs/benchmark-agent-review-claude-10351b11/report.json` | 3 | 100% | 100.0% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-17.md`. Subjective review median score available. |
| `benchmark-agent-review` | Codex | `tests/benchmarks/runs/benchmark-agent-review-codex-dd1c3ebb/report.json` | 1 | 100% | 97.5% | `benchmark/review-benchmark-agent-review-2026-05-17.md` | graded | Curated report: `benchmark/test-benchmark-agent-review-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
...
| `update-packages` | Claude | `tests/benchmarks/runs/update-packages-claude-2611723c/report.json` | 3 | 100% | 86.5% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. Subjective review median score available. |
| `update-packages` | Codex | `tests/benchmarks/runs/update-packages-codex-8d320ac5/report.json` | 1 | 100% | 98.5% | `benchmark/review-update-packages-2026-05-17.md` | graded | Curated report: `benchmark/test-update-packages-2026-05-17.md`. One evaluated persisted run with deterministic quality scoring. Subjective review median score available. |
...
| `run` | Codex | `tests/benchmarks/runs/run-codex-12b0b506/report.json` | blocked/incomplete | Report exists with zero total and evaluated runs. Do not count as benchmarked. Prefer the later evaluated report listed above. |
