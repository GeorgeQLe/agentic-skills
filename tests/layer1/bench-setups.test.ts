        ...
        cases: [
          {
            ...
            reason: "approved alignment YAML has matching route commands",
            ignored_noise: false,
            would_mutate: false,
          },
          {
          ...
          },
          {
            ...
            reason: "Root command is missing, so the invocation comment cannot supply routing.",
            ignored_noise: true,
            would_mutate: false,
          },
          {
            ...
            selected_source: "root_command",
            action: "consume-approval",
            reason: "Root command matches agent_routing; stale invoke comment is ignored.",
            ignored_noise: true,
            would_mutate: false,
          },
          {
            ...
            reason: "Root command and agent_routing.command disagree.",
            ignored_noise: false,
            would_mutate: false,
          },
          {
            ...
            selected_source: "root_command",
            action: "consume-approval",
            reason: "valid route commands agree; stale prose ignored",
            ignored_noise: true,
            would_mutate: false,
          },
          {
            ...
            reason: "page_path alignment/missing-page.html is not present in this repository.",
            ignored_noise: false,
            would_mutate: false,
          },
          {
            ...
            selected_source: "root_command",
            action: "route-parent",
            reason: "complete answer routes to parent root command",
            ignored_noise: true,
            would_mutate: false,
          },
        ],
