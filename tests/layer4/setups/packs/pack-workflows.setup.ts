...
const packWorkflowDefinitions: PackWorkflowDefinition[] = [
  ...
  { skill: "grill-me", pack: "alignment-loop", focus: "adversarial questioning", inputs: ["Claim: users will pay immediately", "Evidence is thin"], expectedPattern: /question|assumption|evidence/i },
