...
4. If the session is already in Plan mode, prefer `request_user_input` for material decisions with 2-3 real options. Otherwise ask concise direct questions in plain text.
...
4. If multiple → list cards and ask the user to pick. If the session is already in Plan mode and there are 2-3 concrete choices, prefer `request_user_input`.
