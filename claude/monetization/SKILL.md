...
> Based on: research/icp.md[, research/competitive-analysis.md, research/journey-map.md, research/metrics.md, research/gtm.md, research/customer-feedback.md]
> Date: [current date]
...
### `research/monetization-interview.md`
...
- **Do not overwrite existing `research/monetization.md`** without asking the user first.
