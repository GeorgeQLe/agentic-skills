...
1. **Gather project context**:
   ...
   - Search for and read project documentation: specs (`spec.md`, `docs/`), changelogs (`CHANGELOG.md`, `CHANGES.md`, `tasks/history.md`), ADRs (`adr/`, `docs/adr/`, `docs/decisions/`), interview logs (`*-__interview.md__`), and design docs.
   - Read `tasks/todo.md` if it exists to understand current plans and in-progress work.
