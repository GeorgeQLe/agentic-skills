...
export default function WorkflowsPage() {
  return (
    <main className="page">
      ...
      <section className="section" aria-labelledby="tui-title">
        <h2 id="tui-title">Interactive Workflow Player</h2>
        <p className="lede">
          Step through each workflow with the playful blueprint player — chip
          selectors, animated step cards, and a lab-notebook sidebar.
        </p>
        <TuiWorkflow />
      </section>
    </main>
