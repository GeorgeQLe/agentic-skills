  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back */}
        <div
          className="absolute inset-0 rounded-xl border border-zinc-300 dark:border-zinc-700/50 bg-gradient-to-br from-white to-zinc-50 dark:from-zinc-900 dark:to-zinc-800 p-3 flex flex-col shadow-lg shadow-black/30"
        ...
        >
          ...
          <p className="text-[11px] text-zinc-600 dark:text-zinc-400 leading-snug mb-3 flex-1">
            {skill.description}
          </p>
          ...
          <div className="mt-auto pt-2 border-t border-zinc-200 dark:border-zinc-700/30 flex flex-wrap gap-1">
            {skill.tags.slice(0, 4).map((tag) => (
              <span
                key={tag}
                className="inline-flex items-center gap-0.5 text-[9px] text-zinc-600 dark:text-zinc-500 bg-zinc-100 dark:bg-zinc-800 px-1 py-0.5 rounded"
              >
                <Tag size={7} />
                {tag}
              </span>
