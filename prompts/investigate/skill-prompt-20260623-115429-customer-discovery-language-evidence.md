...
skill: investigate
agent: codex
captured_at: 2026-06-23T11:54:29-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate while I appreciate the question in customer discovery interrogations: Real buyer or user language
What phrases have you heard, used, or expect prospects to use when describing the pain? I think this question is always answered by me with not real buyer quotes generally, but by what my hunch is and additional research is needed. I want to address this point, but I also think that we should add to the interrogation convention that user open question responses should be double checked and researched to ensure there is supporting evidence and push back if there isn't evidence or evidence to the contrary.
