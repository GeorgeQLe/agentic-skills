...
skill: investigate
agent: codex
captured_at: 2026-06-23T10:51:27-04:00
...
```text
$investigate when I ran npx skillpacks refresh --all --dry-run, it gave this result: Safe to run: no
skillpacks 0.1.11 (latest) but there's not error message or indiciation why safe to run is no
```
