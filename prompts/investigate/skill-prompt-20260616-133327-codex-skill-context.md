...
skill: investigate
agent: codex
captured_at: 2026-06-16T13:33:27-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate I'm noticing that my skills are using up a lot of initial context on codex, I don't think I have that many skills installed, but according to the context counter, I use 5-8% of context just to ask a simple question
