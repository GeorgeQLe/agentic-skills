...
skill: investigate
agent: codex
captured_at: 2026-06-12T11:14:40-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate should we have another skill type (like orchestrator)  which is the interview skill. We've had longstanding relentless agent interviews (interrogations really) and recent changes have regressed that behavior. We should audit to determine if we should make a different interview skill or name it interrogation if you think that would be more descriptive. Give me a report on what you belive we should do for this convention
