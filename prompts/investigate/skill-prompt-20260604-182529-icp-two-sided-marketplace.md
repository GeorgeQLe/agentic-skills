...
skill: investigate
agent: codex
captured_at: 2026-06-04T18:25:29-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate I noticed that for the icp skill, the agent wasn't able to detect that an application was a two-sided marketplace from the idea concept and thus suggested one when there are two. How should we best handle this without adding more context bloat to the existing skill
