...
skill: investigate
agent: codex
captured_at: 2026-05-30T20:26:05-04:00
...
```text
$investigate  can you run an audit of our agents.md and claude.md and the one that is added by provision-agentic-config? Is there anything that we can push down to the skills to keep the agents.md/claude.md clean? Do not implement, compile a report for me.
```
