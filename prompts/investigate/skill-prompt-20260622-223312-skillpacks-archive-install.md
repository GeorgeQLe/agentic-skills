...
skill: investigate
agent: codex
captured_at: 2026-06-22T22:33:12-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate can you audit the npx skillpacks install <pack> and ensure that it is not installing skills from archive? I just did it on a separate device on 0.1.10 and it just installed a bunch of orchestrator subskills (customer discovery) to be precise when I installed the business-afps pack. I thought we had fixed it already
