...
skill: investigate
agent: codex
captured_at: 2026-06-05T00:22:57-04:00
...
```text
$investigate for the creation of html alignment pages, we should change the looks good, approved option in the feedback section to "emphasize" when the user wants the agent to add more weight to something within that section
```

# Directly Attached Visible Context
...
2. **Select investigation strategy** from flags or auto-detection:
   - `--ui`: Visual/layout bugs — start from component tree, styles, animations, transitions, spacing, popover, transition, theme, truncated, glitch, dead space, detached, pop-in, flickering, layout, z-index, overflow.
