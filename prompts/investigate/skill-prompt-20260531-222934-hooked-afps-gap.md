...
skill: investigate
agent: codex
captured_at: 2026-05-31 22:29:34 America/New_York
...
```text
$investigate do we have a skill where we can incorporate nir eyal's hooked model? Focus on the afps workflow and see if we have a gap there
```
