...
skill: investigate
agent: codex
captured_at: 2026-06-15 23:11:03 America/New_York
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate The generator is scripts/upgrade-alignment-page.mjs.

  It reads the canonical alignment-page convention from docs/alignment-page-convention.md, fills in per-skill details, and writes each skill’s generated ALIGNMENT-PAGE.md plus the short ## Alignment Page stub
  in SKILL.md.

  In this ORD-align review, the problem I found is:

  - The committed ORD-align ALIGNMENT-PAGE.md files were stale relative to that generator.
  - Running node scripts/upgrade-alignment-page.mjs --check failed specifically on ORD-align.
  - A plain regenerate would fix drift but would also replace ORD-specific staged validation language with generic staged-research language. How would fix this? Have we come across this with other skills?
