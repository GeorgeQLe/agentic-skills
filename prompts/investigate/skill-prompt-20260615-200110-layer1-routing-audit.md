...
skill: investigate
agent: codex
captured_at: 2026-06-15T20:01:10-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate One note: layer1/skill-alignment-routing-audit.test.ts still fails, but I confirmed the same 44 findings reproduce on an unmodified HEAD export, so that is pre-existing and unrelated to this doc-only
  change.
