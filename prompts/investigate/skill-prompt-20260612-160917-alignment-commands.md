...
skill: investigate
agent: codex
captured_at: 2026-06-12T16:09:17-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate since we've upgraded the alignment page conventions, with our new skill setup, what would be the right commands to
