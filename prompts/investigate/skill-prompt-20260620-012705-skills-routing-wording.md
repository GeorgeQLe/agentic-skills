...
skill: investigate
agent: codex
captured_at: 2026-06-20T01:27:05-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate can we change the wording on our skills routing? ## Next Work

  Review the HTML page, answer the assumption checks and open ICP questions, click Compile Responses, then paste the compiled YAML into a fresh Codex session invoking this same parent skill.

  ## Continue In A Fresh Session

  $customer-discovery research/hulaloops The continue in a fresh session isn't necessary on a compiling YAML step as the next work section states. And in the fresh Codex or Claude session that recieves the yaml, we don't need the previous step to talk about the next step's next steps since the next step will be able to handle its own routing
