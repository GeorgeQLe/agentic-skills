...
skill: investigate
agent: codex
captured_at: 2026-06-22T12:35:47-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate  I noticed that idea-scope-briefing appears to be an old version. Is it still installed globally? Or is it not being refreshed by skillpacks? I noticed that it still does interrogations via the terminal and not via html alignment pages. Investigate and report back, do not implement
