...
skill: investigate
agent: codex
captured_at: 2026-06-27T01:15:22-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$investigate do not implement yet, just report back, can we change the interrogation page's open answer questions to have an apply recommended button which will paste the recommended answer into the text box?
