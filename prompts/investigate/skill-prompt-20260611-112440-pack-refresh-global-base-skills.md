...
skill: investigate
agent: codex
captured_at: 2026-06-11T11:24:40-04:00
...
```
$investigate I noticed that with pack refresh, global skills are not being refreshed and using npx skillpacks wouldn't touch those global skills. Would the new paradigm be that there is a npx skillpacks init which would install "base" skills instead of global skills. That way the base skills for a local repo can be updated and bumped
```
