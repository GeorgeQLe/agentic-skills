...
skill: ship-end
agent: codex
captured_at: 2026-06-05T00:23:49-04:00
...
The original user turn was compacted before this prompt record could be written, so only the visible invocation above remains available in the active transcript. The user-provided context was described as the full local skill body; the current local skill file is reproduced below to preserve the referenced context without fabricating hidden transcript text.

```text
<skill>
<name>ship-end</name>
<path>/home/georgeqle/projects/tools/dev/agentic-skills/.codex/skills/ship-end/SKILL.md</path>
---
name: ship-end
