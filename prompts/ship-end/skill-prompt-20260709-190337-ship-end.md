...
skill: ship-end
agent: codex
captured_at: 2026-07-09T19:03:37-04:00
...
- Do not push session-wrap-up commits to an existing feature branch. Use `commit-and-push-by-feature` to move the work onto `main` or `master`, not on an existing feature branch, and push it there, or stop and report a blocker if that cannot be done safely.
