...
agent: codex
captured_at: 2026-06-10T00:37:33-0400
...
```text
$analyze-sessions on claude, we have this data. Can you confirm and what feedback would you give? Can we improve our skills or add new ones? Last 24h · these are independent characteristics of your usage, not a breakdown

  73% of your usage came from subagent-heavy sessions
   Each subagent runs its own requests. Be deliberate about spawning them — and
   consider configuring a cheaper model for simpler subagents.

  68% of your usage was while 4+ sessions ran in parallel
   All sessions share one limit. If you don't need them all at once, queueing uses
   it more evenly.

  24% of your usage was at >150k context
   Longer sessions are more expensive even when cached. /compact mid-task, /clear
   when switching to new tasks.

  17% of your usage came from subagents under "workflow-subagent"
   If this runs frequently, consider configuring its subagents with a cheaper
   model or tightening their prompts.

  Skills                  % of usage
  /youtube-video-prelaunch-au…    3%
  /pack                           1%
  /idea-scope-brief               1%
  /analyze-sessions               1%
  /session-triage                 1%
