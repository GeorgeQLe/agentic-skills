...
agent: codex
captured_at: 2026-05-31T11:54:46-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

$analyze-sessions should we have a skill which cleans up all copies of the skills that downstream repos (repos that are not this one which is the master holding all the skills) have? Or have an inventory skill which can list the current versions and the current canonical version?
