...
agent: codex
captured_at: 2026-06-14T16:11:46-04:00
...
```text
I want to audit each portion of the claude.md and agents.md created by provision-agentic-config. I want to scrutinize each line in each document and ensure that every one of them is absolutely needed
```
