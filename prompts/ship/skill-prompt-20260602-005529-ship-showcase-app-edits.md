...
skill: ship
agent: codex
captured_at: 2026-06-02T00:55:29-04:00
...
<skill>
<name>ship</name>
<path>/home/georgeqle/projects/tools/dev/agentic-skills/.codex/skills/ship/SKILL.md</path>
---
name: ship
...
- Do not execute or plan from `tasks/record-todo.md` or `tasks/recurring-todo.md`; report their counts only unless an item has first been promoted into `tasks/todo.md`.
