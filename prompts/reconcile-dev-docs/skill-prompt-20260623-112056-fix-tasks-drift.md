...
agent: codex
captured_at: 2026-06-23 11:20:56 America/New_York
source: user-invocation
prompt_scope: visible-user-invocation
---

$reconcile-dev-docs fix tasks and also determine why this keeps happening?

<skill>
<name>reconcile-dev-docs</name>
<path>/Users/georgele/projects/tools/agentic-skills/.codex/skills/reconcile-dev-docs/SKILL.md</path>
---
