...
skill: user-flow-map
agent: codex
captured_at: 2026-06-12T09:02:06-04:00
source: user-invocation
prompt_scope: visible-user-invocation
---

```
$user-flow-map skills-showcase skill-execution-handoff
```

```
<skill>
<name>user-flow-map</name>
<path>/Users/georgele/projects/tools/agentic-skills/.codex/skills/user-flow-map/SKILL.md</path>
---
name: user-flow-map
